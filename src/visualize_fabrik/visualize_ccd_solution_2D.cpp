...
{
  const std::string NODE_NAME = "visualize_ccd_solution";
  ros::init(argc, argv, NODE_NAME);
  ros::AsyncSpinner spinner(1);
  spinner.start();
  ros::NodeHandle node_handle("~");

  ROS_INFO("-------------------------------- make link from CCD ----------- ");
  ...
  ccd::Link link1(link1_name,  link1_frame);

  // ---------------------- Solve two forward kinematics close to each other:
  // ccd::RobotModelPtr robot_model = ccd::makeSimpleRobot2D();

  // ccd::RobotStatePtr robot_state_1 = std::make_shared<ccd::RobotState>(robot_model);
  ...
  // std::vector<Eigen::Vector4d> end_effector_1;
  // end_effector_1.push_back(robot_state_1->getPoint1());
  // end_effector_1.push_back(robot_state_1->getPoint2());
  // end_effector_1.push_back(robot_state_1->getPoint3());
  // robot_state_1->printState("CCD - first configuration", std::vector<int>{-1});

  // ccd::RobotStatePtr robot_state_2 = std::make_shared<ccd::RobotState>(robot_model);   
  // theta_1 = theta_1 + 0.2;
  // theta_2 = theta_2 + 0.2;
  // theta_3 = theta_3 + 0.1;
  ...
  // robot_state_2->printState("CCD - second configuration", std::vector<int>{-1});

  // std::vector<Eigen::Vector4d> end_effector_2;
  // end_effector_1.push_back(robot_state_2->getPoint1());
  // end_effector_1.push_back(robot_state_2->getPoint2());
  // end_effector_1.push_back(robot_state_2->getPoint3());

  // std::vector<Eigen::Vector4d> target = end_effector_2;
